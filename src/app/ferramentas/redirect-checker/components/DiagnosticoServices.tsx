const SERVICES = [
  {
    title: 'Mapeamento completo do sitemap',
    body: 'Todas as URLs analisadas — status HTTP, tempo de resposta, tipo de redirect e destino final.',
  },
  {
    title: 'Identificação de prioridades',
    body: 'Os problemas rankeados por impacto no crawl budget e na indexação. Você sabe o que resolver primeiro.',
  },
  {
    title: 'Plano de correção',
    body: 'Para cada problema identificado, a ação recomendada — sem precisar saber o que é um 301 pra entender o que fazer.',
  },
]

const METRICS = [
  { label: 'Redirects 3xx',       value: '12 encontrados', status: 'warning'  },
  { label: 'Erros 404',           value: '3 encontrados',  status: 'critical' },
  { label: 'Loops detectados',    value: '0',              status: 'ok'       },
  { label: 'URLs lentas (+3s)',    value: '7 encontradas',  status: 'warning'  },
  { label: 'URLs no sitemap',     value: '847 analisadas', status: 'ok'       },
]
...
const STATUS_LABELS = { ok: 'OK', warning: 'Atenção', critical: 'Crítico' }
    ...
    <section id="rc-services" className="relative z-10" style={{ padding: '80px 24px' }}>
      ...
      >
        ...
        <div>
          ...
          >
            Diagnóstico técnico. Plano de ação. Sem achismo.
          </h2>
          ...
          >
            Não adianta supor que o sitemap está ok. A gente verifica cada URL, classifica os problemas por impacto e entrega o caminho mais curto pra correção.
          </p>
        ...
        >
          ...
          >
            {[
              { label: 'URLs sem problema', score: 825, max: 847 },
              { label: 'Saúde geral do sitemap', score: 72, max: 100 },
            ].map((sc) => (
              <div key={sc.label}>
