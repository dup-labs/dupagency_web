const SERVICES = [
  ...
  },
  {
    ...
    body: 'Textos que respondem perguntas reais do seu nicho, com afirmações concretas, dados e estrutura que IAs conseguem extrair e citar.',
  },
  {
    title: 'Estratégia contínua',
    body: 'O ecossistema de IAs muda rápido. A gente acompanha e ajusta sua presença continuamente.',
  },
]

const METRICS = [
  { label: 'Schema Markup',      status: 'ok',       note: 'Implementado' },
  { label: 'Core Web Vitals',    status: 'warning',  note: 'Melhorar LCP' },
  { label: 'Structured Content', status: 'critical', note: 'Ausente' },
  { label: 'Brand Mentions',     status: 'ok',       note: 'Consistente' },
]
    ...
    <section id="geo-services" className="relative z-10" style={{ padding: '80px 24px' }}>
      ...
      >
        ...
        <div>
          ...
          >
            Código e conteúdo. Os dois pilares do GEO.
          </h2>
          ...
          >
            Não adianta ter conteúdo excelente em um site tecnicamente quebrado — nem código
            impecável com texto vago que nenhuma IA consegue citar. A gente resolve os dois lados.
          </p>
        ...
        >
          ...
          <div style={{ display: 'flex', flexDirection: 'column', gap: '14px' }}>
            {[
              { label: 'GEO Readiness', score: 71, max: 100 },
              { label: 'SEO Técnico',   score: 58, max: 100 },
            ].map((sc) => (
              <div key={sc.label}>
                <div
                  style={{
