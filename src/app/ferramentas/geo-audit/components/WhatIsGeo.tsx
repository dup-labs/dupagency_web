const CARDS = [
  {
    ...
    body:
      'IAs buscam afirmações concretas, dados, definições claras e perguntas respondidas diretamente. Conteúdo vago não é citado.',
  },
  {
    icon: (
      <svg width="24" height="24" viewBox="0 0 24 24" fill="none">
    ...
    body:
      'Schema markup, headings hierárquicos, dados estruturados e performance são lidos pelos crawlers das IAs antes de qualquer conteúdo.',
  },
  {
    icon: (
      <svg width="24" height="24" viewBox="0 0 24 24" fill="none">
    ...
    body:
      'Menções externas, consistência de NAP, presença em diretórios e backlinks de qualidade fortalecem o sinal de autoridade para modelos de linguagem.',
  },
  {
    icon: (
      <svg width="24" height="24" viewBox="0 0 24 24" fill="none">
    ...
    title: 'SEO como base',
    body:
      'GEO não substitui SEO — ele amplifica. Um site tecnicamente sólido no Google tem muito mais chance de aparecer nas respostas das IAs.',
  },
]
  ...
  return (
    <section id="geo-what-is-geo" className="relative z-10" style={{ padding: '80px 24px' }}>
      <div style={{ maxWidth: '1040px', margin: '0 auto', position: 'relative' }}>
        ...
        >
          A busca mudou. A maioria dos e-commerces ainda não percebeu.
        </h2>
        ...
        >
          GEO é a prática de otimizar seu conteúdo e estrutura técnica para aparecer nas
          respostas geradas por inteligências artificiais — não só nos resultados do Google.
        </p>
